  ...
  analytics: router({
    ...
    getKeyInsights: protectedProcedure
      ...
      try {
        ...
        // For multi-branch systems, use the same metrics calculation as the dashboard
        ...
        if (isMultiBranch && startDate && !input.branchId) {
          // Consolidated view for multi-branch - use getConsolidatedMetrics (same as metrics card)
