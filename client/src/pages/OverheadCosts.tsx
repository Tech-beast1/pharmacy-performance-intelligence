...
export default function OverheadCosts() {
  ...
  // Dashboard's estimatedProfit is already the Net Profit (after overhead deduction)
  // So we display it as Net Profit, and calculate Gross Profit by adding overhead back
